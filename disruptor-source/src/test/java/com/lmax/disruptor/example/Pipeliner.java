...
public class Pipeliner {
  public static void main(String[] args) {
    Disruptor<PipelinerEvent> disruptor =
        new Disruptor<PipelinerEvent>(PipelinerEvent.FACTORY, 1024, DaemonThreadFactory.INSTANCE);
  ...
  private static class PipelinerEvent {
    private static final EventFactory<PipelinerEvent> FACTORY =
        new EventFactory<PipelinerEvent>() {
          @Override
