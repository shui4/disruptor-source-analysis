...
public class SequenceReportingCallbackTest {
  ...
  public void shouldReportProgressByUpdatingSequenceViaCallback() throws Exception {
    ...
    final SequenceReportingEventHandler<StubEvent> handler =
        new TestSequenceReportingEventHandler();
  ...
  private class TestSequenceReportingEventHandler
      implements SequenceReportingEventHandler<StubEvent> {
