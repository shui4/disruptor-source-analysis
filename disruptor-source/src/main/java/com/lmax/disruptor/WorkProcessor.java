 ...
 *
 * <p>Generally, this will be used as part of a {@link WorkerPool}.
 *
...
public final class WorkProcessor<T> implements EventProcessor {
   ...
   * @param workSequence from which to claim the next event to be worked on. It should always be
   *     initialised as {@link Sequencer#INITIAL_CURSOR_VALUE}
   */
