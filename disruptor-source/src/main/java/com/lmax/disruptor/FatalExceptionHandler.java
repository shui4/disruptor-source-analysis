...
/**
 * Convenience implementation of an exception handler that using standard JDK logging to log the
 * exception as {@link Level}.SEVERE and re-throw it wrapped in a {@link RuntimeException}
 */
